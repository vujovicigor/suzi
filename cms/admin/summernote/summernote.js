      ...
      Statusbar.prototype.initialize = function () {
          ...
          this.$statusbar.on('mousedown', function (event) {
              ...
              var onMouseMove = function (event) {
                  ...
                  // IGOR DODAO if (window.PARENT) window.PARENT.set('height', height+120)
              };
...
//              'floatLeft': 'note-icon-float-left', //IGOR
              'floatLeft': 'note-icon-align-left',
//              'floatRight': 'note-icon-float-right', //IGOR
              'floatRight': 'note-icon-align-right',
              'font': 'note-icon-font',
              ...
              'redo': 'note-icon-redo',
//              'rollback': 'note-icon-rollback', //IGOR
              'rollback': 'note-icon-align-justify',
